...
(function ($) {
    function _6b(_6c) {
        ...
        if (_6e.showPageList) {
            var ps = $("<select class=\"pagination-page-list\" title=\"Pilih jumlah data yang di tampilkan.\"></select>");
    ...
    $.fn.pagination.defaults = {
        ...
        afterPageText: "dari {pages}",
        displayMsg: "Menampilkan <b>{from}</b> sampai <b>{to}</b> data, dari total <b>{total}</b> data."
    };
})(jQuery);
(function ($) {
    function _93(_94) {
...
(function ($) {
    ...
    function init(_3d8) {
        $(_3d8).addClass("calendar").wrapInner("<div class=\"calendar-header\">" + "<div title=\"Bulan sebelumnya.\" class=\"calendar-prevmonth\"></div>" + "<div title=\"Bulan selanjutnya.\" class=\"calendar-nextmonth\"></div>" + "<div title=\"Tahun sebelumnya.\" class=\"calendar-prevyear\"></div>" + "<div title=\"Tahun selanjutnya.\" class=\"calendar-nextyear\"></div>" + "<div class=\"calendar-title\">" + "<span title=\"Ke bulan dan tahun.\">Aprial 2010</span>" + "</div>" + "</div>" + "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">" + "<div class=\"calendar-menu-year-inner\">" + "<span title=\"Tahun sebelumnya.\" class=\"calendar-menu-prev\"></span>" + "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>" + "<span title=\"Tahun selanjutnya.\" class=\"calendar-menu-next\"></span>" + "</div>" + "<div class=\"calendar-menu-month-inner\">" + "</div>" + "</div>" + "</div>");
...
(function ($) {
    ...
    function init(_70b) {
        ...
        $("<span><span title=\"Klik.\" class=\"combo-arrow\"></span></span>").appendTo(span);
