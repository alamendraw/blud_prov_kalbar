<div id="content">
	<h1><?php echo $page_title; ?><span><a href="<?php echo site_url(); ?>/master/rek3_blud">Kembali</a></span></h1>

	<?php echo form_open('master/edit_rek3_blud/'.$rek3->kd_rek3, array('class' => 'basic')); ?>
    <table class="form">
    	 <tr>
