...
?>
	...
	<link rel="shortcut icon" href="<?php echo base_url(); ?>images/soedarso2.png" type="image/x-icon" />
	...
	<div id="header">
    	<div class="title">
			<table cellpadding="0" cellspacing="0" width="200%" align="center" border="0">
				<tr height="80px">
					<td width="130px" valign="bottom" align="center"><img src="<?php echo base_url(); ?>image/soedarso1.png" style="width:75px;margin: 0px 0px 0px 20px;" ></td>
					<td align="left" style="">
						<font style="color:white; font-size:27px; padding-bottom: 5px"  class="shadow">SIMAK-BLUD</font><br />
						<font  style="line-height: 20px; font-size:20px; color:black"  >SISTEM INFORMASI MANAJEMEN KEUANGAN<br>
					...
					</font><font  style="line-height: 20px; font-size:20px; color:white"  class="shadow2"> <?PHP echo $thang ?></font></td>
				</tr>
			</table>
