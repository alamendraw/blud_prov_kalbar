...
class M_spp extends CI_Model {
	...
	function load_rek_spp($ckdkegi,$ckdrek,$beban){
		...
		if (  $ckdrek != '' ){
            $NotIn = " and b.kd_rek5 not in ($ckdrek) " ;
        } else {
            $NotIn = " " ;
        }
        ...
        $sql      = "SELECT DISTINCT b.kd_rek5 as kd_rek_blud, c.nm_rek5 as nm_rek_blud, a.kd_rek5 
					...
					WHERE a.kd_kegiatan = '$ckdkegi' AND a.kd_rek5='$ckdrek' $NotIn  $and order by b.kd_rek5";
	...
	function cetakrincianspp($skpd,$no_spp,$jns,$bk,$pa,$print,$spasi,$tanpa){
		...
		if(($jns=='1')||($jns=='2')){
			...
			$total=0;	
			$i=0;
			$sqldet="SELECT kd_kegiatan,kd_rek5,kd_rek_blud,nm_rek_blud,nilai FROM trdspp_blud WHERE no_spp='$no_spp' AND kd_skpd = '$skpd'";
