    ...
    $(document).ready(function() {
        $('#urusan').combogrid({  
            ...
            textField:'kd_urusan',  
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/rka_blud/urusan',  
            columns:[[  
...
//});
	  ...
	  //$(function(){
		$('#giat').combogrid({  
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>/index.php/rka_blud/ld_giat/'+''+'/'+'',  
            columns:[[  
...
/* 		  $(function(){
        ...
        function validate_giat(skpd,urusan){
		 // $(function(){
			...
			$('#giat').combogrid({  
            url:'<?php echo base_url(); ?>/index.php/rka_blud/ld_giat/'+skpd+'/'+urusan
            });
	...
	$("#dg").edatagrid("selectAll");
        ...
        alert(skpd+urusan);
            $(function(){
			$('#dg').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka_blud/select_giat/'+skpd,
                 idField:'id',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:"true",
                    ...
                    {field:'jns_kegiatan',
					 ...
					 editor:{type:"combobox",
      		                options:{valueField:'jns_kegiatan',
									  ...
									  panelwidth:910,	
									  url :'<?php echo base_url();?>/index.php/rka_blud/ld_jns',
									  required:true									  
									  }
							}
                    },
                    {field:'lanjut',
					 ...
					 editor:{type:"combobox",
      		                options:{valueField:'lanjut',
									  textField:'lanjut',
									  panelwidth:910,	
									  url :'<?php echo base_url();?>/index.php/rka_blud/ld_lanjut',
									  required:true									  
									  }
							}
                    }
	...
	$(function(){
            ...
            //alert(skpd+urusan);
			$('#dg').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka_blud/select_giat',
                 idField:'id',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
                 fitColumns:"true",
        ...
        //alert(urusan+skpd+baru+lama+jns);
            $(function(){
				$('#dg').edatagrid({
				     url: '<?php echo base_url(); ?>/index.php/rka_blud/psimpan/'+skpd+'/'+urusan+'/'+baru+'/'+lama+'/'+$.trim(jns)+'/'+lanjut,
					 idField:'id',
					 toolbar:"#toolbar",              
					 rownumbers:"true", 
					 fitColumns:"true",
        ...
        function hapus(){
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka_blud/ghapus/'+skpd+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
