<div id="content">        
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td>                     
                    <a href="<?php echo site_url(); ?>/rka_blud/preview_rba/<?php echo $skpd->kd_skpd; ?>/<?php echo $skpd->kd_kegiatan; ?>/<?php echo $ttd_pa->nip; ?>" target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
