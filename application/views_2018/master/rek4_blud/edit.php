<div id="content">
	<h1><?php echo $page_title; ?><span><a href="<?php echo site_url(); ?>/master/rek4_blud">Kembali</a></span></h1>

	<?php echo form_open('master/edit_rek4_blud/'.$rek4->kd_rek4, array('class' => 'basic')); ?>
    <table class="form">
    	 <tr>
