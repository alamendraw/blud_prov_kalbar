...
//------------------------ rekening 2 Andika --------------------------------
    ...
    function load_rekening2_blud() {
        ...
        $sql = "SELECT * from ms_rek2_blud $where order by kd_rek2";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
//------------------------ rekening 3 Andika --------------------------------
    ...
    function load_rekening3_blud() {
        ...
        $sql = "SELECT count(*) as tot from ms_rek3_blud $where" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        
        
        $sql = "SELECT * from ms_rek3_blud $where order by kd_rek3 limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function ambil_rekening2_blud() {
        ...
        $sql = "SELECT kd_rek2, nm_rek2 FROM ms_rek2_blud where upper(kd_rek2) like upper('%$lccr%') or upper(nm_rek2) like upper('%$lccr%') ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
//------------------------ rekening 4 Andika --------------------------------//
    ...
    function ambil_rekening3_blud() {
        $lccr = $this->input->post('q');
        $sql = "SELECT kd_rek3, nm_rek3 FROM ms_rek3_blud where upper(kd_rek3) like upper('%$lccr%') or upper(nm_rek3) like upper('%$lccr%') ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function load_rekening4_blud() {
        ...
        $sql = "SELECT count(*) as tot from ms_rek4_blud $where" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        
        
        $sql = "SELECT * from ms_rek4_blud $where order by kd_rek4 limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
function cari_rek4_blud()
    ...
    function edit_rek4_blud()
    {
        ...
        if ( ( $id == "" ) || ( $this->master_model->get_by_id('ms_rek4_buld','kd_rek4',$id)->num_rows() <= 0 ) ) :
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $data['rek4'] = $this->master_model->get_by_id('ms_rek4_buld','kd_rek4',$id)->row();
        ...
        else
        {
            ...
            $this->master_model->update('ms_rek4_buld','kd_rek4',$id, $data);
...
//------------------------ rekening 5 Andika --------------------------------//
    ...
    function ambil_rekening4_blud() {
        $lccr = $this->input->post('q');
        $sql = "SELECT kd_rek4, nm_rek4 FROM ms_rek4_blud where upper(kd_rek4) like upper('%$lccr%') or upper(nm_rek4) like upper('%$lccr%') ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function load_rekening5_blud() {
        ...
        $sql = "SELECT count(*) as tot from ms_rek5_blud a $where" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        
        
        $sql = "SELECT * FROM ms_rek5_blud $where order by kd_rek5 limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
//------------------------ END rekening 7 Andika --------------------------------//
    ...
    function user_group()
    {   
        $this->index2('0','h_user_group','id_group','nm_group','User Group','user_group','');
    }
...
function index($offset=0,$lctabel,$field,$field1,$judul,$list,$lccari)
    ...
    function get_sclient(){
        ...
        $sql = "SELECT kd_skpd,thn_ang,provinsi,kab_kota,daerah,tgl_rka,tgl_dpa,tgl_ubah,tgl_dppa,rek_kasda,rek_kasin,rek_kasout,rk_skpd,rk_skpkd,spd_head1,spd_head2,spd_head3,spd_head4,
               ingat1,ingat2,ingat3,ingat4,ingat5, no_qanun, tgl_qanun, no_perbup, tgl_perbup,no_perda_ubah,tgl_perda_ubah,no_perbup_ubah,tgl_perbup_ubah,lamp_perda,lamp_perbup,lamp_perda_ubah,lamp_perbup_ubah FROM sclient";
    ...
    function load_dyn_menu($lc=""){
      if($lc==""){
            $query = $this->db->query("SELECT * FROM dyn_menu ORDER BY page_id");
      }else{
            $query = $this->db->query("SELECT * FROM dyn_menu a WHERE a.id NOT IN (SELECT id_menu FROM d_user_group b WHERE id_group = '$lc') ORDER BY page_id");
      }
      $result = array();
      $ii = 0;
...
function load_d_user_group($lc=""){
      $query = $this->db->query("SELECT a.id_group, a.id_menu, b.title FROM d_user_group a INNER JOIN dyn_menu b ON a.id_menu = b.id WHERE a.id_group = '$lc' order by a.id_menu");
      $result = array();
      $ii = 0;
...
function simpan_h_user_group(){
      ...
      if($status=="tambah"){
            $query = $this->db->query("insert into h_user_group (id_group,nm_group) values ('$kode','$nama')");
      }else{
            $query = $this->db->query("update h_user_group set nm_group= '$nama' where id_group = '$kode'");
      }
...
function load_h_user_group(){
        $query = $this->db->query("SELECT * FROM h_user_group ORDER BY CAST(id_group AS SIGNED)");
        $result = array();
        $ii = 0;
...
function hapus_h_user_group(){
      $kode = $this->input->post('vkode');
      $msg = array();

      $query = $this->db->query("delete from h_user_group where id_group = '$kode'");
      if($query){
            $query1 = $this->db->query("delete from d_user_group where id_group = '$kode'");
            if($query1){
                  $msg = array('pesan' => '0');
            }
      }else{
...
function simpan_d_user_group(){
      $kode = $this->input->post('vkode');
      $sql = $this->input->post('vsql');
      $msg = array();

      $query = $this->db->query("delete from d_user_group where id_group = '$kode'");
      if($query){
            $sequel = "insert into d_user_group (id_group, id_menu) ".$sql;
      ...
      echo json_encode($msg);
        ...
        function cek_login_user(){
            ...
            $type = "";
            if($userId != ""){
                $sql = $this->db->query("select type from user where id_user = '$userId'");
    ...
    function simpan_toni(){
        ...
        if($res->num_rows()>0){
            ...
            $sql = "insert into user(user_name,password,type,nama,kd_skpd,id_group) values ('$cus','$cpa','$cty','$cnm','1.02.02.00','$csgroup')";
            $asg = $this->db->query($sql);
            if($asg){
                echo '2';
            }else{
    ...
    function simpan_otorisasi_user($cus='',$cgroup=''){
        $cus = $cus;
        $grup = $cgroup;
		$sql = " SELECT id_user FROM user WHERE user_name = '$cus' ";
                 
        $query1 = $this->db->query($sql);
        foreach($query1->result_array() as $resulte){
            $jr=$resulte['id_user'];
        }
        $sql1 = "delete from otori where user_id= '$jr' ";
        $this->db->query($sql1);
		
        $sql1 = "insert into otori SELECT '$jr', id_menu, '1' from d_user_group WHERE id_group = '$grup'";
        $this->db->query($sql1);
  ...
  function update_toni(){
        ...
        if($res->num_rows() > 0){
            if ($resulte['password'] == $cpas){
                $sql1 = "update user set user_name='$cus',password='$cpas',type='$cty',nama='$cnm',id_group='$csgroup' where id_user='$cidus'";
                ...
                if($asg1){
                 ...
                 $sql = "update user set user_name='$cus',password='$cpa',type='$cty',nama='$cnm',id_group='$csgroup' where id_user='$cidus'";
                $asg = $this->db->query($sql);
                if($asg){
                    echo '2';
                }else{
    ...
    function load_otorisasi() {
        ...
        $sql="select count(*) as tot FROM dyn_menu a $where";
        $query1 = $this->db->query($sql);
        $trh = $query1->row();

        //$sql = "SELECT a.id as idx,a.title as title, (SELECT IF(b.akses=1,'YA','TIDAK') FROM otori b where b.menu_id=a.id AND user_id='$test') AS status FROM dyn_menu a $where ORDER BY a.id
        //        limit $offset,$rows ";
        
        $sql = "SELECT a.id AS idx, a.title AS title, IF(b.akses=1,'YA','TIDAK')  AS status FROM dyn_menu a
        LEFT JOIN otori b ON b.menu_id = a.id WHERE b.user_id='$test' $where ORDER BY a.id limit $offset,$rows";
    ...
    function load_unit_skpd($kode='') {                
        $sql = "SELECT * from ms_unit where kd_skpd='$kode' order by kd_unit";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function ambil_kegiatan() {
        $lccr = $this->input->post('q');
        $sql = "SELECT kd_kegiatan, nm_kegiatan FROM m_giat where upper(kd_kegiatan) like upper('%$lccr%') or upper(nm_kegiatan) like upper('%$lccr%') ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function load_kegiatan() {
        ...
        $sql = "SELECT count(*) as tot from m_giat $where" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        
        
        $sql = "SELECT * from m_giat $where order by kd_kegiatan limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
	...
	function load_kegiatan2() {
        ...
        $sql = "SELECT count(*) as tot from m_giat $where" ;
		//$sql = "SELECT count(*) as tot from m_giat" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        
        
        $sql = "SELECT * from m_giat $where order by kd_kegiatan";
		//$sql = "SELECT * from m_giat order by kd_kegiatan limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function load_rekening4() {
        ...
        $sql = "SELECT * from ms_rek4 $where order by kd_rek4 limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
	...
	function load_rekening5() {
        ...
        $sql = "SELECT a.*,b.nm_rek64 AS nm_lo FROM ms_rek5 a LEFT JOIN ms_rek5 b ON a.map_lo=b.kd_rek64 $where order by kd_rek64 limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    function load_ttd() {
        ...
        $sql = "SELECT * from ms_ttd $where order by nip limit $offset,$rows";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
...
//    }
	...
	function cmb_ttd(){
		...
		$sql	= "	SELECT nip, nama, jabatan FROM ms_ttd WHERE kd_skpd = '$skpd'  $and_ 
