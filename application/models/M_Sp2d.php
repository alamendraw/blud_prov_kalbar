...
class M_sp2d extends CI_Model {
	...
	function cetak_sp2d($lntahunang,$lcnosp2d,$lcttd,$lckdskpd,$cetak,$banyak,$jns_cetak){
		...
		$n  = $trhn->nilai;
				...
				$sqlttd1="SELECT nama as nm,nip as nip,jabatan as jab,pangkat FROM ms_ttd_blud where nip='$lcttd'";
            ...
            <td colspan=\"2\">
                <table style=\"border-collapse:collapse;font-family: Tahoma;font-size:11px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\">
                    <tr >
                        ...
                        <td width=\"32%\" align=\"center\"><b>KODE REKENING</b></td>
			...
			$sql_total="SELECT sum(nilai)total FROM trdspp_blud where no_spp='$lcnospp' AND kd_skpd='$lckdskpd'";
				...
				$sql1 = "SELECT COUNT(*) as jumlah FROM(
						...
						if($jumlahbaris<=$banyak){
							$sql = "SELECT 1 as urut, a.kd_kegiatan, left(a.kd_rek5,1) as kd_rek, b.nm_rek1 as nm_rek, a.nilai 
									FROM trdspp_blud a LEFT JOIN ms_rek1 b ON left(a.kd_rek5,1)=b.kd_rek1 
									WHERE no_spp = '$lcnospp' and kd_skpd = '$lckdskpd'
									union all
									SELECT 2 as urut, a.kd_kegiatan, left(a.kd_rek5,2) as kd_rek, b.nm_rek2 as nm_rek, a.nilai 
									FROM trdspp_blud a LEFT JOIN ms_rek2 b ON left(a.kd_rek5,2)=b.kd_rek2 
									WHERE no_spp = '$lcnospp' and kd_skpd = '$lckdskpd'
									union all
									SELECT 3 as urut, a.kd_kegiatan, left(a.kd_rek5,3) as kd_rek, b.nm_rek3 as nm_rek, a.nilai 
									FROM trdspp_blud a LEFT JOIN ms_rek3 b ON left(a.kd_rek5,3)=b.kd_rek3 
									WHERE no_spp = '$lcnospp' and kd_skpd = '$lckdskpd'
									union all
									SELECT 4 as urut, a.kd_kegiatan, left(a.kd_rek5,5) as kd_rek, b.nm_rek4 as nm_rek, a.nilai 
									FROM trdspp_blud a LEFT JOIN ms_rek4 b ON left(a.kd_rek5,5)=b.kd_rek4 
									WHERE no_spp = '$lcnospp' and kd_skpd = '$lckdskpd'
									union all
									SELECT 5 as urut, a.kd_kegiatan, a.kd_rek5 as kd_rek, b.nm_rek5 as nm_rek, a.nilai 
									FROM trdspp_blud a LEFT JOIN ms_rek5 b ON a.kd_rek5=b.kd_rek5 
									WHERE no_spp = '$lcnospp' and kd_skpd = '$lckdskpd'
									union all
									SELECT 6 as urut, a.kd_kegiatan, a.kd_rek5+b.plus_ang as kd_rek, b.nm_rek5 as nm_rek, a.nilai 
									...
									ORDER BY urut, kd_kegiatan,kd_rek";	
                                       ...
                                       // $lntotal = 0;
                                        ...
                                        {	
											...
											$kd_rekx = $row->kd_rek;
											$kd_rek = $this->tukd_model->dotrek($kd_rekx);
                                           ...
                                           $cRet .="<tr>
                                                        ...
                                                        <td style=\"border-bottom: hidden;\">&nbsp; $row->kd_kegiatan.$kd_rek </td>
