...
class Tukd_blud extends CI_Controller {
	...
	function load_sp2d_sts($cskpd='') {
			...
			$sql = "SELECT no_sp2d,jns_spp,CASE jns_spp WHEN '4' THEN 'LS GAJI' WHEN '5' THEN 'LS GAJI DAN PENAGIHAN' WHEN '6' THEN 'LS BARANG/JASA' WHEN '1' THEN 'UP' WHEN '2' THEN 'GU' ELSE 'TU' END AS jns_cp from trhtransout_blud  WHERE kd_skpd = '$lcskpd' AND upper(no_sp2d) like upper('%$lccr%')" ;
 ...
 function cetak_daftar_penguji($no_uji='',$ttd='',$dcetak='',$cetak='',$atas='',$bawah='',$kiri='',$kanan=''){
    ...
    function load_no_tetap() { 
        ...
        $sql = "SELECT no_tetap, tgl_tetap, kd_skpd, keterangan, nilai, kd_rek5, kd_rek_blud,
				(SELECT a.nm_rek5 FROM ms_rek5 a WHERE a.kd_rek5=tr_tetap_blud.kd_rek5) as nm_rek,kd_kegiatan FROM tr_tetap_blud $where $where2
				UNION ALL
				...
				FROM 
				(SELECT *,(SELECT a.nm_rek5 FROM ms_rek5 a WHERE a.kd_rek5=tr_tetap_blud.kd_rek5) as nm_rek FROM tr_tetap_blud $where )a
				LEFT JOIN
	...
	function cetaklpjup_ag(){
		...
		$cRet .=" <table style=\"border-collapse:collapse;font-size:12px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
				...
				$sql = "SELECT 1 as urut, LEFT(a.kd_kegiatan,18) as kode, b.nm_program as uraian, SUM(a.nilai) as nilai
						...
						UNION ALL
						SELECT 6 as urut, kd_kegiatan+'.'+kd_rek5 as kode, nm_rek5 as uraian, SUM(nilai) as nilai FROM trlpj_blud
...
//====================================================================================  
    ...
    function ambil_rek_tetap() {
        ...
        trdrka_blud a left join ms_rek5 b on a.kd_rek5=b.kd_rek5 left join ms_rek4 c on left(a.kd_rek5,5)=c.kd_rek4 
  ...
  function ambil_sdana_trans() {
   ...
   $sql ="SELECT a.kd_rek5, a.nm_rek5 FROM trdrka_blud a  WHERE a.kd_kegiatan= '$giat' AND a.kd_skpd = '$kode'  $notIn";
	...
	function load_tetap() {
		...
		$sql = "
		SELECT top $rows a.*, (SELECT b.nm_rek5 FROM ms_rek5 b WHERE a.kd_rek5=b.kd_rek5) as nm_rek5 FROM tr_tetap_blud a WHERE a.kd_skpd='$skpd'
...
//          $query1->free_result();  
	...
	select no_sts nomor, 'Pengembalian Transaksi' ket, kd_skpd from trhkasin_blud where jns_trans in ('1','4','5','6') and isnumeric(no_sts)=1 
