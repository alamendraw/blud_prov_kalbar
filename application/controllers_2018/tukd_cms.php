                        ...
                        if (!($asg)){
                            ...
                            $asg = $this->db->query($sql);
                                ...
                                echo json_encode($msg);                     
                                    ...
                                    $sql = "INSERT INTO trdtransout_blud (no_bukti, no_sp2d, kd_kegiatan, nm_kegiatan, kd_rek5, nm_rek5, nilai, kd_skpd, kd_rek_blud)
                                            SELECT c.no_bukti, a.no_sp2d, b.kd_kegiatan, b.nm_kegiatan, b.kd_rek5, b.nm_rek5, b.nilai, b.kd_skpd, b.sumber
                                        ...
                                        WHERE c.no_validasi='$nval' and a.status_trmpot='1' and c.kd_bp='$skpd'";
                                            ...
                                            if (!($asg)){
                                                ...
                                                echo json_encode($msg);                     
                                                    ...
                                                    $sql = "INSERT INTO trdtrmpot_blud(no_bukti, kd_rek5, nm_rek5, nilai, kd_skpd, kd_rek_trans)
                                                    SELECT cast(c.no_bukti as int)+1 as no_bukti, b.kd_rek5, b.nm_rek5, b.nilai, b.kd_skpd, b.kd_rek_trans
